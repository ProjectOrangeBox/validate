...
class Filters extends RuleAbstract
{
    ...
    public function filename(): void
    {
        ...
        */
        $this->input = \strtolower(\trim((string) \preg_replace('#\W+#', '_', (string) $this->input), '_'));
    ...
    public function length(): void
    {
        ...
        $this->input = substr((string) $this->input, 0, (int)$length);
    }
    ...
    public function upper(): void
    {
        ...
        $this->input = strtoupper((string) $this->input);
    }
    ...
    public function base64(): void
    {
        ...
        if ($this->option == 'encode') {
            $this->input = base64_encode((string) $this->input);
        } else {
            $this->input = base64_decode((string) $this->input);
        }
    }
    ...
    public function md5(): void
    {
        ...
        $this->input = md5((string) $this->input);
    }
    ...
    public function sha1(): void
    {
        ...
        $this->input = sha1((string) $this->input);
    }
    ...
    public function passwordHash(): void
    {
        ...
        $this->input = password_hash((string) $this->input, PASSWORD_DEFAULT);
    }
